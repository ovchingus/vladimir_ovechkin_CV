...
\begin{center}
    \textbf{\Huge \scshape Vladimir Ovechkin} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:359876925520}{+359 87 6925520}
    $|$
    \faAt \hspace{.5pt} \href{mailto:ovchingus@gmail.com}{ovchingus@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/vladimir-ovechkin/}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/ovchingus}{GitHub}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://www.google.com/maps/place/Sofia,+Bulgaria/@42.6955288,23.2415464,12z/data=!3m1!4b1!4m6!3m5!1s0x40aa8682cb317bf5:0x400a01269bf5e60!8m2!3d42.6977082!4d23.3218675!16zL20vMGZ0ang?entry=ttu}{Sofia, Bulgaria}
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Bachelor of Computer Science;   \textbf{GPA: 4.00/5.00}}{Sep 2017 \textbf{--} Jun 2021}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ JavaScript, TypeScript, Java, Python, SQL} \\ \vspace{3pt}
        
        \textbf{Technologies:}{ Node.js, React.js, GraphQL, REST APIs, RxJS, Express.js, Sass/Scss, Jest, Redux, I18n, MySQL, MongoDB, Git, Docker} \\ \vspace{3pt}
